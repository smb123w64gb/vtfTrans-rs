...
pub fn vtf2xtf<P: AsRef<Path>>(input:P,output:P,half:bool){
    ...
    for a in &mut newmips{
        if half && a.level.len() > 1{
            ...
            mipskip = 1; //Technicly we could go further!
        }
        a.reverse();
